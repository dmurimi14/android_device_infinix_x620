...
$(call inherit-product, device/infinix/sdm660-common/platform.mk)

# Device Path
DEVICE_PATH := device/infinix/x620
...
# Vendor files
$(call inherit-product, vendor/infinix/x620/x620-vendor.mk)

# AOSP DEVICE
PRODUCT_NAME := aosp_x620
PRODUCT_DEVICE := x620
PRODUCT_MODEL := Infinix ZERO 6 (AOSP)
